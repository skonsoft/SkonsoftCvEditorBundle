...
class CvProfile
{
     ...
     * @ORM\OneToMany(targetEntity="CvEducationHistory", mappedBy="CvProfile")
     */
    ...
    /**
     * @param \Doctrine\Common\Collections\ArrayCollection $cvEducationHistories
     */
    public function setCvEducationHistories(ArrayCollection $cvEducationHistories) {
